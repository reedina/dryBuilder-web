...
@Component({
  styleUrls: ['aws-authentications.component.css'],
  template: `
  <app-aws-authentications-display></app-aws-authentications-display>
...
export class AwsAuthenticationsComponent  implements OnInit {
