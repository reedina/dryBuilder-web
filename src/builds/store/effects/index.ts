...
import { UserDataFilesEffects } from './user-data-file.effects';

export const effects: any[] = [AwsRegionsEffects, AwsInstanceTypesEffects, AwsAuthsEffects,
    PackerBuilderTypesEffects, AmiFilterLinuxesEffects, EbsBuildersEffects, UserDataFilesEffects ];
...
export * from './user-data-file.effects';
