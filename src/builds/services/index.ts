...
import { UserDataFilesService } from './user-data-files.service';

export const services: any[] = [AwsRegionsService, AwsInstanceTypesService, AwsAuthsService,
    PackerBuilderTypesService, AmiFilterLinuxesService, EbsBuildersService, UserDataFilesService];
...
export * from './user-data-files.service';